        ...
        <script>
            $(document).ready(function() {
                ...
                $('#dataTable').on('click', '.item_edit', function (e) {
                    ...
                    itemPopup.setTitle('Edit Slider');
                    itemPopup.load("{{route('aGetSlider')}}?id="+editId, function () {
                        this.open();
                    });
                });
                ...
                $('#add_item').on('click', function (e) {
                    ...
                    itemPopup.setTitle('Add Slider');
                    itemPopup.load("{{route('aGetSlider')}}", function () {
                        this.open();
                    });
                });
