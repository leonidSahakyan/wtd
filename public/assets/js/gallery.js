          ...
          Dropzone.options.myDropzone = {
              ...
              init: function() {
                  this.on("addedfile", function(file) {
                      ...
                      var removeButton = Dropzone.createElement("<button style='width:100%' class='btn removeImage btn-sm btn-info btn-block'>Remove</button>");
                  ...
                  if($uploadedImages){
                    ...
                    $.each($uploadedImages, function( index, value ) {                      
                      var mockFile = { name: value.title, size: value.size, id:value.id };
